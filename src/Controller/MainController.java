...
public class MainController {
    ...
    public FXMLLoader getFXMLLoader(String loaderResource){
        ...
        if (loaderResource.equals("waiting_frame"))
            loader = new FXMLLoader(this.getClass().getResource("/fxml/WaitingFrame.fxml"));
    ...
    public void switchScreen(String loaderResource, boolean fadeAnimation){
        ...
        if (loaderResource.equals("waiting_frame")){
            WaitingController menuController = loader.getController();
            menuController.setMainController(this);
            menuController.load_data();
        }
    ...
    public int getIfAdmin() { return ifAdmin; }

    public void setIfAdmin(int ifAdmin) { this.ifAdmin = ifAdmin; }
